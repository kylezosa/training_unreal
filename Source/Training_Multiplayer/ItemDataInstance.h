...
struct TRAINING_MULTIPLAYER_API FS_ItemDataInstance
{
	GENERATED_BODY()
public:
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item|S_DataInstance")
	FGuid ItemInstanceID;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item|S_DataInstance")
	class US_ItemDataAsset* ItemDataAsset;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item|S_DataInstance")
	struct FS_ItemProperties ItemProperties;
